...
<div class="modal-dialog modal-dialog-small animated fadeIn">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo Yii::t('UserModule.views_auth_login', '<strong>Sign-in</strong> to the network'); ?></h4>
        </div>
                ...
                <div class="tab-pane <?php echo (!isset($_POST['Invite'])) ? "active" : ""; ?>" id="login">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <small>
                                <?= Yii::t('UserModule.views_auth_login', 'Forgot uy password?'); ?>
                                <br/>
